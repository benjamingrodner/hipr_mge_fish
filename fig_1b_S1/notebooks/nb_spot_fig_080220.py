...
group_filenaming = ['single','ten','branch']
...
# %% codecell
# =============================================================================
# Select filter for spot intensity
# =============================================================================
...
for i, threshold in zip(I, thresholds):
    ...
    ax.set_xlim(0.0018, 0.005)
    ax.set_ylim(-10, 10000)
    ip.plt.show()
    ip.plt.close()
# %% codecell
# Pick threshold
thresholds = (0.0035, 0.003, 0.005)
# Plot on the curves
for i, threshold in zip(I, thresholds):
    fig, ax = ip.general_plot(col='k', dims=(10,3))
    for j in J:
...
# %% codecell
# get curves
x = np.linspace(0,0.1,1000)  # thresholds
