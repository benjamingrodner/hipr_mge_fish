...
Running on old images from 2021_06_02_airyscan
...
config_fn = 'config_2021_06_02_airyscan.yaml' # relative path to config file from workdir
...
input_filenames = glob.glob(config['input_dir'] + '/*Stitch' + config['input_ext'])
