...
# %% codecell
# Absolute path
project_workdir = '/fs/cbsuvlaminck2/workdir/bmg224/manuscripts/mgefish/code/fig_5/fig_5b/HiPRFISH'
...
classifier_script = config['__default__']['SCRIPTS_PATH'] + '/' + config['reference_training']['script']
...
input_fns = [os.path.splitext(os.path.basename(fn))[0] for fn in input_fns]
input_fns = [re.sub(r'(?<=spec)\d{3}', '', fn) for fn in input_fns]
