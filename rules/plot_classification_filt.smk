...
rule plot_classification_filt:
    input:
        seg_fn = config['output_dir'] + '/' + config['seg_fmt'],
        classif_fn = config['output_dir'] + '/' + config['classif_filt_fmt'],
    output:
        seg_col_fn = config['output_dir'] + '/' + config['seg_filt_col_fmt'],
        plot_seg_col_fn = config['output_dir'] + '/' + config['plot_seg_filt_col_fmt'],
        plot_classif_legend_fn = config['output_dir'] + '/' + config['plot_classif_filt_legend_fmt'],
    params:
