...
def classify_spectra(input_spectra, ref_clf):
    ...
    print('\n','avgint_norm.shape', avgint_norm.shape,'\n')
    ...
    for r in range(20):
        avgint_identification_filename = '{}_cell_information.csv'.format(sample)
...
#             nn_indices, nn_dists = umap_transform.nearest_neighbors(avgint_norm, n_neighbors=1, metric='cosine')
...
#             cell_info.columns = ['channel_{}'.format(i) for i in range(63)] + ['intensity_classification_{}'.format(i) for i in range(4)] + ['umap_1', 'umap_2', 'umap_3', 'cell_barcode', 'nn_dists']
            cell_info.columns = ['channel_{}'.format(i) for i in range(63)] + ['intensity_classification_{}'.format(i) for i in range(4)] + ['umap_1', 'umap_2', 'cell_barcode', 'nn_dists']
            ...
            cell_info_filename = '{}_cell_information.csv'.format(sample)
