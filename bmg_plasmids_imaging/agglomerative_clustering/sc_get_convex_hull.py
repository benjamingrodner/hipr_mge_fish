...
def main():
    ...
    parser.add_argument(
        "-sp", "--support_points_relpos_fn", dest="support_points_relpos_fn", type=str, help=""
    )
    parser.add_argument("-td", "--tile_dist", dest="tile_dist", type=str, help="")
    parser.add_argument("-od", "--output_dir", dest="output_dir", type=str, help="")
